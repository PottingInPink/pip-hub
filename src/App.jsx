...
import GlazeTracker from './GlazeTracker'
...
function App() {
  ...
  useEffect(() => {
    if (selectedCategory && selectedCategory !== 'Sales Tracking' && selectedCategory !== 'Glaze Inventory') {
  ...
  return (
    <div className="app-container">
      ...
      {currentView === 'log' && selectedCategory === 'Glaze Inventory' && (
        <GlazeTracker onBack={handleBack} />
      )}

      {currentView === 'log' && selectedCategory && selectedCategory !== 'Sales Tracking' && selectedCategory !== 'Glaze Inventory' && (
